...
namespace Scenaristar                           
{
    public partial class MainForm : Form
    {
...
#if DEBUG
            ScenarioNumNumericUpDown.Maximum = 9;
        ...
        private class MyRenderer : ToolStripProfessionalRenderer
        {
            ...
            protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
            {
                if (e.Item is ToolStripMenuItem)
                    e.ArrowColor = Program.ProgramColors.TextColor;
        ...
        private void CompileImage(int ImageIndex)
        {
            ...
            switch (ScenarioList[ImageIndex].Type)
            {
                ...
                case ScenarioSMG2.StarType.Green:
                    ...
                    break;
                case ScenarioSMG2.StarType.Bronze:
                    g.DrawImage(Properties.Resources.BronzeStar, 48f, 98f);
                    break;
        ...
        private void StarCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            ScenarioSMG2 X = (ScenarioSMG2)ScenarioListView.SelectedItems[0].Tag;
#if DEBUG
            X.CalculateStarID(new CheckBox[9] { Star1CheckBox, Star2CheckBox, Star3CheckBox, Star4CheckBox, Star5CheckBox, Star6CheckBox, Star7CheckBox, Star8CheckBox, Star9CheckBox });
#else
...
#region Timer Stuff
        ...
        private void ImageSizeToolStripComboBox_Click(object sender, EventArgs e)
        {

        }

        private void CurrentFileToolStripTextBox_Click(object sender, EventArgs e)
        {
        ...
        private void yAZ0ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ReloadTheme()
        {
            ...
            {
                Controls[i].BackColor = Program.ProgramColors.ControlBackColor;
                Controls[i].ForeColor = Program.ProgramColors.TextColor;
            }
            ForeColor = Program.ProgramColors.TextColor;
            object p = BackColor = Program.ProgramColors.ControlBackColor;
            ...
            {
                FileToolStripMenuItem.DropDownItems[i].BackColor = Program.ProgramColors.WindowColor;
                FileToolStripMenuItem.DropDownItems[i].ForeColor = Program.ProgramColors.TextColor;
            }
            for (int i = 0; i < EditToolStripMenuItem.DropDownItems.Count; i++)
            {
                EditToolStripMenuItem.DropDownItems[i].BackColor = Program.ProgramColors.WindowColor;
                EditToolStripMenuItem.DropDownItems[i].ForeColor = Program.ProgramColors.TextColor;
            }
