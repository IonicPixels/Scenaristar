...
namespace GalaxyMaps
{
    ...
    public class ScenarioSMG2
    {
        ...
        public void CalculateStarID(System.Windows.Forms.CheckBox[] Checks)
        {
            ...
            if (Checks.Length > 6 && Checks[8].Checked) starmask ^= 256;
        ...
        public bool[] CalculateStarID(int Input, bool UseLast)
        {
            ...
            bool chkStar9 = ((starmask & 256) != 0);
            if (UseLast)
                return new bool[9] { chkStar1, chkStar2, chkStar3, chkStar4, chkStar5, chkStar6, chkStar7, chkStar8, chkStar9 };
            else
